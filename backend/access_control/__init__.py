...
@dataclass
class AccessControlEntry: ace_id:str; user_id:str; resource_type:str; resource_id:str; permission:str; def to_dict(self):return asdict(self)
@dataclass
class AuditLogEntry: log_id:str; user_id:str; action:str; resource:str; timestamp:str=""; details:str=""; def to_dict(self):return asdict(self)

class AccessControlSystem:
    def __init__(self): self._aces: List[AccessControlEntry] = []; self._audit: List[AuditLogEntry] = []
    def grant(self, ace: AccessControlEntry): self._aces.append(ace); return ace
    ...
    def log(self, entry: AuditLogEntry): self._audit.append(entry); return entry
