...
@dataclass
class SolutionAsset: asset_id:str; name:str; asset_type:str; industry:str; creator:str; price:float=0.0; rating:float=0.0; version:str="1.0"; status:str="published"; def to_dict(self):return asdict(self)

class SolutionMarketplace:
    def __init__(self): self._assets: Dict[str, SolutionAsset] = {}
    def publish(self, a: SolutionAsset): self._assets[a.asset_id] = a; return a
