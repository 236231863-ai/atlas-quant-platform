...
@dataclass
class ProcurementOrder: order_id:str; asset_id:str; org_id:str; status:str="search"; approved:bool=False; contract_id:str=""; def to_dict(self):return asdict(self)

class EnterpriseProcurementFlow:
    def __init__(self): self._orders: Dict[str, ProcurementOrder] = {}
    def create(self, o: ProcurementOrder): self._orders[o.order_id] = o; return o
