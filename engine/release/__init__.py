...
@dataclass
class ReleasePlan: version:str; canary_percent:float=0.1; risk_score:float=0.0; suggested_action:str=""; rollback_plan:str=""; def to_dict(self):return asdict(self)

class ReleaseIntelligenceEngine:
    def __init__(self): self._releases: List[ReleasePlan] = []
