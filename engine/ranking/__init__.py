...
class RankScore:
    ...
    def overall(self):
        return round((self.research_quality+self.backtest_quality+self.risk_control+self.community_contribution+self.knowledge_contribution)/5, 4)
    def to_dict(self):
        return asdict(self)

class ResearchRankEngine:
    def __init__(self):
        self._scores: Dict[str, RankScore] = {}
    def evaluate(self, score: RankScore):
        self._scores[score.researcher_id] = score
        return score
