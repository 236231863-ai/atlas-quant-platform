...
@dataclass
class IndustryExpert: expert_id:str; name:str; expert_type:str="industry_expert"; skills:List[str]=field(default_factory=list); cases:List[str]=field(default_factory=list); contributions:int=0; certified:bool=False; def to_dict(self):return asdict(self)

class ExpertNetwork:
    def __init__(self): self._experts: Dict[str, IndustryExpert] = {}
    def register(self, e: IndustryExpert): self._experts[e.expert_id] = e; return e
