...
@dataclass
class FusedKnowledge: fusion_id:str; entity:str; sources:List[str]; relation:str="related"; confidence:float=0.5; description:str=""; def to_dict(self):return asdict(self)

class KnowledgeFusionEngine:
    def __init__(self): self._knowledge: Dict[str, FusedKnowledge] = {}
    def fuse(self, knowledge: FusedKnowledge): self._knowledge[knowledge.fusion_id] = knowledge; return knowledge
