...
@dataclass
class AssetLicense: license_id:str; asset_id:str; licensee:str; license_type:str="subscription"; revenue:float=0.0; author_earnings:float=0.0; status:str="active"; def to_dict(self):return asdict(self)

class LicenseEconomyManager:
    def __init__(self): self._licenses: Dict[str, AssetLicense] = {}
    def issue(self, l: AssetLicense): self._licenses[l.license_id] = l; return l
