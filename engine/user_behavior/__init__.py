...
class UserBehaviorEvent:
    ...
    def to_dict(self): return {"event_id": self.event_id, "user_id": self.user_id, "event_type": self.event_type,
...
class BehaviorAnalyzer:
    def __init__(self): self._events: List[UserBehaviorEvent] = []
    def record(self, e: UserBehaviorEvent): self._events.append(e); return e
