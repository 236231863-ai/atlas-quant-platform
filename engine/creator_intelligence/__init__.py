...
@dataclass
class CreatorInsight: creator_id:str; engagement_score:float=0.0; revenue_generated:float=0.0; growth_potential:float=0.0; recommended_actions:List[str]=field(default_factory=list); def to_dict(self):return asdict(self)

class CreatorIntelligence:
    def __init__(self): self._insights: Dict[str, CreatorInsight] = {}
