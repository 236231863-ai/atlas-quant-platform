...
class DashboardEcosystemLayer:
    def __init__(self):
        self._data = EcosystemDashboardData()
    def update_agent_ranking(self, ranking: List[Dict[str, Any]]):
        self._data.agent_ranking = ranking
    def update_evolution_tree(self, tree: List[Dict[str, Any]]):
        self._data.evolution_tree = tree
    def update_competition_history(self, history: List[Dict[str, Any]]):
        self._data.competition_history = history
    def update_resource_allocation(self, allocation: Dict[str, Any]):
        self._data.resource_allocation = allocation
    def update_civilization_timeline(self, timeline: List[Dict[str, Any]]):
        self._data.civilization_timeline = timeline
