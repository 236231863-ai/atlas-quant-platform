...
class ResearchDashboardV2:
    def __init__(self):
        self._data = DashboardDataV2()
    def update_agent_status(self, agents: List[Dict[str, Any]]):
        self._data.agent_status = agents
    def update_team_activity(self, activities: List[Dict[str, Any]]):
        self._data.team_activity = activities
    def update_debate_history(self, debates: List[Dict[str, Any]]):
        self._data.debate_history = debates
    def update_decision_timeline(self, decisions: List[Dict[str, Any]]):
        self._data.decision_timeline = decisions
    def update_knowledge_evolution(self, evolution: Dict[str, Any]):
        self._data.knowledge_evolution = evolution
