...
@dataclass
class ModelRecord: model_id:str; name:str; version:str="1.0"; status:str="candidate"; metrics:Dict[str,float]=field(default_factory=dict); created_at:str=""; def to_dict(self):return asdict(self)

class ModelHub:
    def __init__(self): self._models: Dict[str, ModelRecord] = {}; self._versions: Dict[str, List[str]] = {}
    def register(self, model: ModelRecord): self._models[model.model_id] = model; return model
