...
@dataclass
class ResearchSignal: signal_id:str; signal_type:str; description:str; confidence:float=0.5; severity:str="info"; source:str=""; def to_dict(self):return asdict(self)

SIGNAL_TYPES = {"trend":"Trend Signal","risk":"Risk Signal","opportunity":"Opportunity Signal","anomaly":"Anomaly Signal"}

class SignalGenerator:
    def __init__(self): self._signals: List[ResearchSignal] = []
    def generate(self, signal: ResearchSignal): self._signals.append(signal); return signal
