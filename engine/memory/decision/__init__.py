...
@dataclass
class DecisionRecord: decision_id:str; decision:str; prediction:str; actual_result:str; accuracy:float=0.0; lesson:str=""; def to_dict(self):return asdict(self)

class DecisionMemorySystem:
    def __init__(self): self._records: Dict[str, DecisionRecord] = {}
    def record(self, record: DecisionRecord): self._records[record.decision_id] = record; return record
