...
class ResearchDepartmentManager:
    def __init__(self): self._departments: Dict[str, ResearchDepartment] = {}
    def create(self, dept: ResearchDepartment): self._departments[dept.dept_id] = dept; return dept
