...
class ResearchMemoryUpgrade:
    ...
    def record_success(self, sr: SuccessReason): self._success.append(sr)
    def record_failure(self, fr: FailureReason): self._failures.append(fr)
    def record_condition(self, sc: StrategyCondition): self._conditions.append(sc)
    def record_insight(self, ri: ResearchInsight): self._insights.append(ri)
