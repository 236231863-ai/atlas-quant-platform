...
class CivilizationMemory:
    ...
    def record_era(self, era: EraRecord):
        self._eras[era.era_id] = era
    def record_discovery(self, discovery: DiscoveryRecord):
        self._discoveries[discovery.discovery_id] = discovery
    def record_generation(self, gen_id: str, agents: List[str]):
        self._generations[gen_id] = agents
