...
class AgentContribution:
    ...
    def overall(self): return round((self.research_score+self.knowledge_score+self.innovation_score)/3, 4)
    def to_dict(self): return asdict(self)

class ContributionRewardEngine:
    def __init__(self): self._contributions: Dict[str, AgentContribution] = {}
