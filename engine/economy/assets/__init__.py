...
class AssetPrice:
    ...
    def compute(self): self.final_price = round((self.base_value+self.usage_score+self.impact_score+self.demand_score)/4, 2)
    def to_dict(self): return asdict(self)

class ScientificAssetMarket:
    def __init__(self): self._prices: Dict[str, AssetPrice] = {}
    def register(self, price: AssetPrice): price.compute(); self._prices[price.asset_id] = price; return price
