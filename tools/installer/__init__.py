...
@dataclass
class InstallState: current_step:int=0; completed:bool=False; errors:List[str]=field(default_factory=list)
from typing import List
Installer.__init__.__annotations__={}
@dataclass
class Installer:
    ...
    def get_progress(self): return self.state.current_step/len(STEPS)
