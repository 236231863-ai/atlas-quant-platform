...
@dataclass
class UpdateInfo: current_version:str="3.5.1"; latest_version:str="3.5.1"; update_available:bool=False; download_url:str=""; changelog:str=""; def to_dict(self):return {"current":self.current_version,"latest":self.latest_version,"available":self.update_available}

class AutoUpdater:
    def __init__(self): self._version="3.5.1"
